...
rm -f "$KIRO_HOME/steering/testing-standards.md" 2>/dev/null && echo "  ✓ Removed steering/testing-standards.md" || true
...
rm -f "$KIRO_HOME/scripts/disable-pagers.sh" 2>/dev/null && echo "  ✓ Removed scripts/disable-pagers.sh" || true
